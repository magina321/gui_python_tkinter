...
vuelta = Button(frame5, text = 'VUELTA',relief = "raised", bd=4, bg='blue2', font=('Arial', 12, 'bold'), width =20, command = vueltas)
vuelta.grid(column=1, row=0,padx =10, pady=10, sticky='nsew')

fin = Button(frame5, text = 'RESTABLECER',relief = "raised",bd=4,  bg='red2', font=('Arial', 12, 'bold'), width =20, command = reiniciar)
